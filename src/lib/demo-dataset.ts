...
/** Spark 2만/일 기준 방문자 약 60명 수용 — 실측 328건, 상한 400. */
export const DEMO_DATASET_WRITE_CAP = 400;
...
/** 대화 80~120줄 (v3 R2 — Spark 쓰기 한도 방어). */
export const DEMO_CHAT: DemoChatLine[] = [
  { day: -29, hour: 10, speaker: 0, text: '4조 채팅방 개설했어요! 과제 주제는 캠퍼스 혼잡도 예측으로 정해진 거 다들 아시죠?' },
  { day: -29, hour: 10, speaker: 1, text: '네! 저 모델링 맡고 싶은데 일단 데이터부터 모으죠' },
  { day: -29, hour: 11, speaker: 2, text: '저 문서랑 발표 준비할게요. 데이터는 어떤 거 쓸까요?' },
  { day: -29, hour: 11, speaker: 0, text: '교시별 강의실 예약 데이터랑 셔틀버스 카드 태그 데이터가 있대요. 학과 사무실에 요청해봤어요' },
  { day: -29, hour: 14, speaker: 1, text: '시설관리팀 API도 있대요. 건물별 시간대 유동인구요' },
  { day: -29, hour: 14, speaker: 2, text: '그럼 세 소스 정리해서 공유폴더에 올려둘게요' },
  { day: -28, hour: 9, speaker: 0, text: '사무실에서 데이터 샘플 왔어요. csv 2개예요' },
  { day: -28, hour: 10, speaker: 1, text: '받았습니다. 스키마 제가 볼게요' },
  { day: -28, hour: 16, speaker: 1, text: '카드 데이터는 시간 컬럼이 KST인데 예약 데이터는 UTC더라고요. 전처리 때 통일해야 해요' },
  { day: -28, hour: 16, speaker: 0, text: '좋은 포인트! 문서에 기록해둬요' },
  { day: -27, hour: 10, speaker: 2, text: '데이터셋 정리 문서 만들었어요. 확인 부탁드려요' },
  { day: -27, hour: 10, speaker: 0, text: '보고 있어요. 깔끔하네요' },
  { day: -26, hour: 13, speaker: 1, text: '결측치가 꽤 있어요. 수요일 오후가 유독 비어있네요' },
  { day: -26, hour: 13, speaker: 0, text: '그날 시스템 점검일이었대요. 보간 처리해요' },
  { day: -25, hour: 11, speaker: 2, text: '전처리 코드 작성 할 일 만들어둘게요. 준호님 담당으로' },
  { day: -25, hour: 11, speaker: 1, text: '네 금방 할게요' },
  { day: -24, hour: 15, speaker: 1, text: '전처리 파이프라인 1차 완성. 결측 보간 + 시간대 통일 + 이상치 제거까지 했어요' },
  { day: -24, hour: 15, speaker: 0, text: '와 빠르다! 완료 처리해뒀어요' },
  { day: -23, hour: 10, speaker: 2, text: '시각화 초안 나왔어요. 요일별·교시별 히트맵이요' },
  { day: -23, hour: 10, speaker: 0, text: '화요일 3교시가 제일 붐비네요. 직관적이에요' },
  { day: -20, hour: 9, speaker: 0, text: '데이터 수집 마일스톤 완료! 이제 모델 학습 단계예요' },
  { day: -20, hour: 9, speaker: 1, text: 'baseline은 XGBoost로 잡을게요. 시계열 특성은 lag 피처로 넣고요' },
  { day: -20, hour: 10, speaker: 2, text: 'LSTM은요? 시계열이면 딥러닝이 낫지 않을까요?' },
  { day: -20, hour: 10, speaker: 1, text: '데이터가 12주치라 LSTM은 과적합 위험이 있어요. 비교 실험은 해볼게요' },
  { day: -19, hour: 14, speaker: 1, text: 'baseline_model.ipynb 올렸어요. MAE 18.7명 나왔어요' },
  { day: -19, hour: 14, speaker: 0, text: '오! 기록해둘게요' },
  { day: -18, hour: 10, speaker: 2, text: '문서에 baseline 성능표 만들어뒀어요' },
  { day: -17, hour: 11, speaker: 0, text: '중간보고 슬라이드 초안 서연님이랑 같이 짜볼까요?' },
  { day: -17, hour: 11, speaker: 2, text: '네! 목차부터 정리할게요' },
  { day: -16, hour: 15, speaker: 1, text: 'lag 1, 2, 7일 피처 추가했더니 MAE 16.2로 떨어졌어요' },
  { day: -16, hour: 15, speaker: 0, text: '좋아요! 중간보고에 넣어요' },
  { day: -15, hour: 10, speaker: 0, text: '내일 회의 공학관 401호에서 2시! 다들 가능하죠?' },
  { day: -15, hour: 10, speaker: 2, text: '네 가능해요' },
  { day: -15, hour: 10, speaker: 1, text: '갑니다' },
  { day: -14, hour: 14, speaker: 2, text: '오늘 회의 자료 정리한 거 올렸어요' },
  { day: -14, hour: 14, speaker: 0, text: '수고했어요. 회의 참석 체크해둘게요' },
  { day: -13, hour: 9, speaker: 1, text: '피처 엔지니어링 정리했어요. 수용인원 대비 예약율이 제일 예측력 좋네요' },
  { day: -13, hour: 9, speaker: 0, text: '그거 문서에 강조해둬요' },
  { day: -12, hour: 11, speaker: 2, text: '참고논문 3편 요약했어요. pdf로 올릴게요' },
  { day: -12, hour: 11, speaker: 1, text: '감사합니다! temporal fusion transformer 쪽도 읽어볼게요' },
  { day: -11, hour: 13, speaker: 0, text: 'LSTM 비교 실험 이번 주 안에 가능할까요?' },
  { day: -11, hour: 13, speaker: 1, text: '해볼게요. 다만 시간 부족하면 XGBoost로 갈 것 같아요' },
  { day: -10, hour: 10, speaker: 2, text: '간트 보니까 결과 분석 마일스톤이 3일 뒤부터네요. 일정 괜찮을까요?' },
  { day: -10, hour: 10, speaker: 0, text: '모델 학습이 예상보다 빨라요. 괜찮아요' },
  { day: -9, hour: 14, speaker: 1, text: 'LSTM 초기 결과 MAE 17.1. 아직은 XGBoost가 나아요' },
  { day: -9, hour: 14, speaker: 0, text: '그럼 하이퍼파라미터 튜닝으로 XGBoost를 다듬어요' },
  { day: -8, hour: 10, speaker: 2, text: '모델 비교 문서 업데이트했어요. 표로 정리했어요' },
  { day: -8, hour: 10, speaker: 0, text: '확인했어요. 이대로 최종 보고서에 쓰면 되겠어요' },
  { day: -7, hour: 9, speaker: 1, text: 'Optuna로 튜닝 시작했어요. 100 trials 돌려볼게요' },
  { day: -7, hour: 9, speaker: 0, text: '시간 얼마나 걸려요?' },
  { day: -7, hour: 9, speaker: 1, text: '4시간 정도요' },
  { day: -6, hour: 15, speaker: 1, text: '튜닝 결과 MAE 14.8! 목표였던 15명 이하 달성했어요' },
  { day: -6, hour: 15, speaker: 0, text: '드디어! 서연님 보고서 업데이트 부탁드려요' },
  { day: -6, hour: 15, speaker: 2, text: '네! 최종 보고서 초안 쓸게요' },
  { day: -5, hour: 10, speaker: 0, text: '발표는 누가 맡을까요?' },
  { day: -5, hour: 10, speaker: 2, text: '제가 해볼게요. 자료는 제가 다시 정리할게요' },
  { day: -5, hour: 10, speaker: 0, text: '좋아요. 리허설은 발표 전날 해요' },
  { day: -4, hour: 11, speaker: 1, text: '혼잡도 시각화 png 새로 만들었어요. 지도 위에 오버레이했어요' },
  { day: -4, hour: 11, speaker: 2, text: '오 예쁘다! 발표자료에 바로 넣을게요' },
  { day: -3, hour: 9, speaker: 0, text: '결과 분석 마일스톤 시작! ablation 실험 누가 할래요?' },
  { day: -3, hour: 9, speaker: 1, text: '저 할게요. 근데 이번 주 과제가 세 개라 좀 밀려요' },
  { day: -3, hour: 9, speaker: 0, text: '괜찮아요. 마감 여유 있어요' },
  { day: -2, hour: 20, speaker: 3, text: '안녕하세요, 태윤이에요. 늦어서 미안해요. 이제 합류했어요' },
  { day: -2, hour: 20, speaker: 0, text: '오 안녕하세요! 평가·실험 파트 부탁드려요' },
  { day: -2, hour: 20, speaker: 3, text: '네! ablation 실험 제가 도울게요. 무엇부터 하면 돼요?' },
  { day: -2, hour: 21, speaker: 1, text: '피처를 하나씩 빼보면서 MAE 변화를 보면 돼요. 노트북 공유해요' },
  { day: -2, hour: 21, speaker: 3, text: '받았습니다. 내일 아침에 결과 올릴게요' },
  { day: -2, hour: 21, speaker: 2, text: '태윤님 어서와요~ 문서 정리 현황은 여기 있어요' },
  { day: -2, hour: 21, speaker: 3, text: '감사합니다! 지금 보고 있을게요' },
  { day: -1, hour: 9, speaker: 3, text: 'lag_7을 빼면 MAE가 15.3으로 올라가요. 7일 lag이 제일 중요한 피처네요' },
  { day: -1, hour: 9, speaker: 1, text: '오 저도 같은 결과! 태윤님 덕분에 ablation 정리됐어요' },
  { day: -1, hour: 9, speaker: 0, text: '완료 처리해뒀어요. 태윤님 감사해요' },
  { day: -1, hour: 10, speaker: 2, text: '발표자료 v1 올렸어요. 첨삭 부탁드려요' },
  { day: -1, hour: 10, speaker: 0, text: '지금 볼게요' },
  { day: -1, hour: 10, speaker: 1, text: '3페이지 수치가 최신이 아니네요. 14.8로 바꿔요' },
  { day: -1, hour: 11, speaker: 2, text: '반영했어요!' },
  { day: -1, hour: 14, speaker: 0, text: '최종 보고서 초안 거의 다 됐어요. 다들 각자 파트 확인해주세요' },
  { day: -1, hour: 14, speaker: 3, text: '실험 파트 확인했어요. 오타 하나 고쳤어요' },
  { day: -1, hour: 16, speaker: 2, text: '발표 리허설 대본 정리 중이에요. 10분 분량 맞췄어요' },
  { day: -1, hour: 16, speaker: 0, text: '좋아요. 질문 예상 항목도 준비해주면 좋겠어요' },
  { day: 0, hour: 8, speaker: 0, text: '오늘 오후 발표 리허설 할게요. 다들 참석해주세요' },
  { day: 0, hour: 8, speaker: 2, text: '네! 슬라이드 최종본 곧 올릴게요' },
  { day: 0, hour: 8, speaker: 1, text: '네 참석해요. 시연용 노트북도 챙길게요' },
  { day: 0, hour: 8, speaker: 3, text: '네! 실험 결과 표 정리해서 올렸어요' },
  { day: 0, hour: 9, speaker: 2, text: '발표자료 최종본 업로드했어요. 첨삭 환영해요' },
  { day: 0, hour: 9, speaker: 0, text: '지금 확인하고 피드백 남길게요. 다들 오늘 고생 많았어요!' },
];
