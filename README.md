...
- 코드네임: `nmbd` — 도메인·저장소는 코드네임을 그대로 쓰고, 사람에게 보이는 이름만 **Dibs** 로 통일합니다

---

## 무엇을 해결하나

대학 팀플의 기여도 다툼은 대부분 "누가 얼마나 했는지 증거가 없다"에서 시작합니다. Dibs 는 판정하지 않습니다. **다섯 축(문서·자료·할 일·회의·기록)을 따로 세고, 공백이 보이게** 할 뿐입니다.
